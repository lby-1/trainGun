<p align="center">
  ...
  <p align="center">
    ...
    <img src="https://img.shields.io/badge/PWA-支持离线-blueviolet?style=for-the-badge" alt="PWA Support">
...
- **自定义播放列表**：创建属于你的训练计划
- **自动流转**：模式间自动切换，无缝衔接
- **内置例程**：包含 "每日热身" 和 "点击大师" 预设

### 🔫 沉浸式武器系统
- **可视化枪械**：赛博朋克风格的 3D 枪械模型
- **动态反馈**：真实的后坐力动画、呼吸摆动、换弹下潜
- **视觉特效**：Muzzle Flash 枪口火焰、弹壳抛射（计划中）
- **4 种预设**：Standard, Vandal, Sheriff, Operator

### 📊 深度数据分析
- **象限分析** (Quadrant Error)：分析你的甩枪偏差倾向（如“习惯性打低”）
- **射击散布图**：相对于目标的命中点分布可视化
- **详细统计**：最高分、平均分、命中率、反应时间趋势

### ⌨️ 全键位自定义
- 支持重映射 **开火**、**开镜 (ADS)**、**换弹**、**武器切换**
- 即时生效，无需刷新
...
### 🔧 游戏灵敏度同步
- 支持 **CS2** / **Valorant** / **Apex** / **OW2** 等主流 FPS
- 自动计算 **cm/360**
